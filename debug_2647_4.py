...
# Create dummy effective dates map
effective_dates = {}
for emp in detailed_df["No."].unique():
    effective_dates[emp] = (pd.to_datetime(start_date), pd.to_datetime(end_date))

summary_df, detailed_out = rg.generate_summary_report(detailed_df, start_date, end_date, effective_dates)
